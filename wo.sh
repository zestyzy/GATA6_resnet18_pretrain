...
# ================= 路径参数（按你的机器改） =================
DATA_ROOT="/mnt/e/public/yzeng/codespace/yzeng/6yuan_task/task3_GATA6/data/origin/中山医院有标签136"
LABEL_CSV="/mnt/e/public/yzeng/codespace/yzeng/6yuan_task/task3_GATA6/data/pipline/ssl/Step1_Resnet50_dataset/dataset/teacher_train_95.csv"
RUNS_DIR="/mnt/e/public/yzeng/codespace/yzeng/6yuan_task/task3_GATA6/data/pipline/ssl/Step1_Resnet50_dataset/result"
...
EXP_CROP["A2"]="bbox";    EXP_CH["A2"]=1
EXP_CROP["A3"]="bbox";    EXP_CH["A3"]=2
EXP_CROP["A4"]="none";    EXP_CH["A4"]=2
EXP_CROP["A4"]="none";    EXP_CH["A4"]=1

ARCHES=("resnet18" "resnet50")

# ================ 主循环 ================
for ARCH in "${ARCHES[@]}"; do
  for EXP in "A2" "A3" "A4" "A4-1ch"; do
